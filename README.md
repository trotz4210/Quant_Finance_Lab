...
│   ├── data_collector.py   # yfinance API Crawler
│   ├── market_data.db      # SQLite Database for OHLCV storage
│   └── database_manager.py # SQL interaction handler
│
...
- [x] **Automated Crawler:** Fetching OHLCV data using yfinance API (`data_collector.py`).
